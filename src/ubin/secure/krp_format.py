...
TRANSFER_MAGIC = b"UBT5"
TRANSFER_MAJOR = 0
TRANSFER_MINOR = 5
TRANSFER_FLAG_KRP = 0x0001
TRANSFER_FLAGS_ALLOWED = TRANSFER_FLAG_KRP
...
class KrpTransferHeader:
    ...
    def unpack(
        ...
        if flags != TRANSFER_FLAG_KRP:
            raise UbinProtocolError("UBIN v0.5 KRP flag is required")
